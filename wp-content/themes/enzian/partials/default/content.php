        ...
        <div class="post_item-content">
            <div class="entry-meta">
                ...
                if(is_sticky() && !is_paged()){
                    echo sprintf('<span class="sticky-post">%s</span>', esc_html__('Featured', 'enzian'));
                }
                ?>
            </div>
            <?php
            ...
            <div class="entry-more">
                <a href="<?php the_permalink(); ?>" class="button button-readmore"><?php echo get_post_type() === 'post' ? esc_html__('Read more', 'enzian') : esc_html__('View more', 'enzian'); ?></a>
            </div>
        </div>
    </div>
</article>